...
import { DatabaseLeaderboardEntry } from './leaderboard';
...
/**
 * Payload for a leaderboard update event.
 * - `skill`: The skill for which the leaderboard is updated.
 * - `leaderboard`: The updated array of leaderboard entries.
 */
...
export interface ServerToClientEvents {
  ...
  leaderboardUpdate: (payload: LeaderboardUpdatePayload) => void;
}
